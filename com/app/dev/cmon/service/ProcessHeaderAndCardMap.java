...
public class ProcessHeaderAndCardMap extends CmonManagedBean implements Serializable {
	...
	private HashMap<String, Integer> covHeaderList1 = new HashMap<String, Integer>();
	private HashMap<String, Integer> compHeaderList1 = new HashMap<String, Integer>();
	...
	public boolean isHighlighted(String fullName) {
		if (fullName.contains("Symantec")) {
			return fullName != null && radar.getViewText() != null && radar.getViewText().toLowerCase().contains(fullName.toLowerCase());
		} else {
			return fullName != null && radar.getViewText() != null
					&& radar.getViewText().toLowerCase().equalsIgnoreCase(fullName.toLowerCase());
		}
	}
	...
	public Map<String, List<ViewInfo>> getLeftCardDataMap() {
		return leftCardDataMap;
	}

	public void setLeftCardDataMap(Map<String, List<ViewInfo>> leftCardDataMap) {
		this.leftCardDataMap = leftCardDataMap;
	}
