...
import com.arabbank.hdf.digitalbackend.digital.configuration.cache.services.sme.cardsCache.LoggingConcurrentMapCacheManager;
...
public class CacheConfiguration {
	...
	public CacheManager cacheManager() {
		LoggingConcurrentMapCacheManager cacheManager = new LoggingConcurrentMapCacheManager(
				"transactions",
				"activeUsers",
				"registrations",
				"connections"
		...
		// Combine the existing cache names with the new ones from getAllCacheNames
		List<String> allCacheNames = new ArrayList<>(cacheManager.getCacheNames());
		allCacheNames.addAll(getAllCacheNames());

		// Set the combined cache names
